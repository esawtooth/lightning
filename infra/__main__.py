...
gitea_cg = aci_group(
    ...
    [
        ...
        containerinstance.EnvironmentVariableArgs(name="AAD_CLIENT_SECRET", secure_value=aad_password.value),
...
ui_cg = aci_group(
    ...
    [
        ...
        containerinstance.EnvironmentVariableArgs(name="AAD_CLIENT_SECRET", secure_value=aad_password.value),
        containerinstance.EnvironmentVariableArgs(name="AAD_TENANT_ID", value=aad_tenant_id),
        containerinstance.EnvironmentVariableArgs(name="SESSION_SECRET", secure_value=aad_password.value),
