...
class TestPlanValidation:
    ...
    def test_01_simple_summarization_plan_validation(self):
        ...
        print(f"Failed validators: {[r.validator_name + ': ' + r.error_message for r in failed_validators]}")
        ...
        assert expected_passing.issubset(actual_passing), f"Expected validators failed: {expected_passing - actual_passing}"
    ...
    def test_validation_error_scenarios(self):
        ...
        tool_validator_result = next((r for r in results if r.validator_name == "tools"), None)
    ...
    def test_external_event_validation(self):
        ...
        external_validator_result = next((r for r in results if r.validator_name == "external_events"), None)
