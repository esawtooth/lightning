...
class FunctionConfig:
    ...
    def add_event_trigger(
        self, event_types: List[str], topic: Optional[str] = None
    ) -> None:
    ...
    def add_timer_trigger(self, cron_expression: str) -> None:
        ...
        self.triggers.append(
            {"type": TriggerType.TIMER.value, "schedule": cron_expression}
        )
...
class ServerlessRuntime(ABC):
    ...
    async def deploy_function(
        self, config: FunctionConfig, handler: FunctionHandler
    ) -> str:
        """
