...
class RuntimeConfig:
    ...
    serverless_provider: str = (
        "local"  # local, azure_functions, lambda, cloud_functions
    )
    ...
    def from_env(cls) -> "RuntimeConfig":
        ...
        config.container_registry_username = os.getenv(
            "LIGHTNING_CONTAINER_REGISTRY_USERNAME"
        )
        config.container_registry_password = os.getenv(
            "LIGHTNING_CONTAINER_REGISTRY_PASSWORD"
        )
        ...
        # Security
        config.auth_enabled = (
            os.getenv("LIGHTNING_AUTH_ENABLED", "true").lower() == "true"
        )
        config.encryption_enabled = (
            os.getenv("LIGHTNING_ENCRYPTION_ENABLED", "true").lower() == "true"
        )
